...
const FinancialsScreen = ({ navigation }) => {
  ...
  const fetchTransactions = useCallback(async () => {
    try {
      ...
      showNotification(
        err.response?.data?.msg || "Failed to fetch transactions.",
        "error"
      );
    }
  }, [showNotification]);
  ...
  const fetchClients = useCallback(async () => {
    try {
      ...
      showNotification(
        err.response?.data?.msg || "Failed to fetch clients.",
        "error"
      );
    }
  }, [showNotification]);
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      ...
      showNotification(
        err.response?.data?.msg || "Failed to add transaction.",
        "error"
      );
    }
  };
            ...
            <View style={styles.modalView}>
              ...
              <Picker
                ...
                onValueChange={(itemValue) =>
                  handleInputChange("client", itemValue)
                }
                style={styles.picker}
              >
